    ...
    def search
      if params["Sport"]
        ...
        if positions_with_athletes.count > 1
          @athletes = positions_with_athletes.flat_map {|athelte| athlete.players}.uniq
        else
          @athletes = positions_with_athletes.map {|athlete| athelte.players}.flatten
        end
